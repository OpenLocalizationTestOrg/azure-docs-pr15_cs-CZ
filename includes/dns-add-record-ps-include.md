...
V tomto příkladu jsme použít název sada záznamů "@" u vrcholu zone vytvořit záznam MX (v tomto případě "contoso.com"). To je běžné záznamy MX.
...
Pokud vytváříte SRV záznam v kořenovém zóně, stačí zadejte *_service* a *_protocol* v názvu záznamu. Je nutné zadat "@" v názvu záznamu.
...
### <a name="create-a-txt-record-set-with-a-single-record"></a>Vytvoření záznamu TXT sada se jeden záznam

...
Ke konfiguraci a otestujte Azure AD jednotné přihlašování s Kiteworks, je potřeba provést následující stavební bloky:
...
Cílem tento oddíl je vytvoření uživatele s názvem Britta Simon v Kiteworks.

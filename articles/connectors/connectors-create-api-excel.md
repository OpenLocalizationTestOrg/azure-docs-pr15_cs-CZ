<properties
pageTitle="Přidání konektoru aplikace Excel | Microsoft Azure"
description="Základní informace o konektoru aplikace Excel pomocí rozhraní REST API parametry"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Začínáme s konektoru aplikace Excel

V aplikacích pro použití logických operátorů v současné době není žádný konektoru aplikace Excel. 

## <a name="to-use-excel-data"></a>Použití dat aplikace Excel
Data aplikace Excel mohou být uloženy jako textový soubor s oddělovači (CSV) soubor ve složce úložiště, jako je [OneDrive](connectors-create-api-onedrive.md). Taky můžete tento soubor CSV s [soubor spojnice](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md).

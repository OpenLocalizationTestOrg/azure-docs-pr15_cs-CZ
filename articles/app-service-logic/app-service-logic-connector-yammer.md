<properties
   pageTitle="Pomocí konektoru Yammer v aplikacích pro použití logických operátorů | Aplikace služby Microsoft Azure"
   description="Jak vytvořit a nakonfigurovat aplikaci Yammer spojnice nebo rozhraní API a použít v aplikaci logiky v aplikaci služby Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-yammer-connector"></a>Jsme jste lepší konektoru Yammeru 
...
- [Další informace o této nové spojnice](../connectors/connectors-create-api-yammer.md)

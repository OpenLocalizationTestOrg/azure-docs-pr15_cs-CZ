<properties
   pageTitle="Vytvořit virtuální síť pomocí rozhraní příkazového řádku Azure | Microsoft Azure"
   description="Zjistěte, jak vytvořit virtuální síť pomocí rozhraní Azure příkazového řádku v ARM | Správce prostředků."

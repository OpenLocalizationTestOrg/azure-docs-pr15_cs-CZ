<properties
    pageTitle="Počítače výukové algoritmus pomocný | Microsoft Azure"
    description="Tisknutelné počítače výukové algoritmus pomocný umožňuje vybrat správné algoritmus prediktivní modelu v Azure počítače výukové Studio."
    keywords="algoritmus pomocný, pomocný, algoritmus výukové počítače"
...
# <a name="machine-learning-algorithm-cheat-sheet-for-microsoft-azure-machine-learning-studio"></a>Počítač výukových algoritmus pomocný k Microsoft Azure počítače výukové Studio

**Aktualizace Microsoft Azure počítače výukové algoritmus cheaty list** umožňuje vybrat správné algoritmus modelu prediktivní analýzy.

[Azure počítače výukové Studio](https://studio.azureml.net/) má velkou knihovnu algoritmů z ***regresní***, ***zařazení***, ***clusterů***a ***odchylky zjišťování*** rodiny. Každý je určená jiný typ počítače výukové problém řešit.


## <a name="download-machine-learning-algorithm-cheat-sheet"></a>Položka ke stažení: Počítače výukové algoritmus pomocný

**Stáhněte si pomocný tady: [Počítače výukové algoritmus cheaty list (11 × 17 palců)](http://download.microsoft.com/download/A/6/1/A613E11E-8F9C-424A-B99D-65344785C288/microsoft-machine-learning-algorithm-cheat-sheet-v6.pdf)**

![Počítač výukové algoritmus pomocný: Naučte se zvolte algoritmu výukové počítače.][cheat-sheet]

[cheat-sheet]: ./media/machine-learning-algorithm-cheat-sheet/machine-learning-algorithm-cheat-sheet-small_v_0_6-01.png

Stáhnout a vytisknout na počítači výukové algoritmus cheaty list v velikost a mít ji po ruce získat pomoc s výběrem algoritmus.

> [AZURE.NOTE] Podrobné pokyny k používání Tento pomocný najdete v článku [Výběr algoritmy pro Microsoft Azure počítače Learning](machine-learning-algorithm-choice.md) .

## <a name="more-help-with-algorithms"></a>Další nápovědu k algoritmů

* Diskuse hlubší různé typy algoritmů výukové počítače, jejich použití a jak používat tento pomocný pro výběr doprava algoritmus najdete v článku [jak zvolte algoritmy pro Microsoft Azure počítače učení](machine-learning-algorithm-choice.md).

...
Zkopírujte a vložte následující kód způsobu **GetStartedDemo** pod vytvoření databáze. Tím vytvoříte kolekci dokument s názvem *FamilyCollection_oa*.
...
##<a id="GetSolution"></a>Získání úplné řešení výuková NoSQL
